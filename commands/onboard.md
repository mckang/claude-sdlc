...
**더 읽기**: [${CLAUDE_PROJECT_DIR}/docs/prd/email-verification.md](${CLAUDE_PROJECT_DIR}/docs/prd/email-verification.md)
...
**더 읽기**: [${CLAUDE_PROJECT_DIR}/docs/architecture/email-verification.md](${CLAUDE_PROJECT_DIR}/docs/architecture/email-verification.md)
...
- 최신 상태: `/status ${CLAUDE_PROJECT_DIR}/docs/plans/email-verification.md`
...
# Story 착수
/story start E2-S2 ${CLAUDE_PROJECT_DIR}/docs/plans/email-verification.md

# 기술 결정 회의
/meeting backend, security, dba | <주제> | ${CLAUDE_PROJECT_DIR}/docs/meetings/<이름>.md

# PR 본문 자동 생성
/pr E2-S2 ${CLAUDE_PROJECT_DIR}/docs/plans/email-verification.md
