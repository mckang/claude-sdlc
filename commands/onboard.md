...
/onboard --feature=checkout-v2       # 특정 기능만
/onboard --role=frontend --feature=checkout # 조합
```

## 1단계: 인자 파싱

- `--role=` (선택): `backend`, `frontend`, `fullstack`, `data`, `qa`, `any` (기본)
...
**더 읽기**: [${CLAUDE_PROJECT_DIR}/docs/prd/prd-checkout-v2.md](${CLAUDE_PROJECT_DIR}/docs/prd/prd-checkout-v2.md)
...
**더 읽기**: [${CLAUDE_PROJECT_DIR}/docs/architecture/architecture-checkout-v2.md](${CLAUDE_PROJECT_DIR}/docs/architecture/architecture-checkout-v2.md)
...
- 최신 상태: `/status ${CLAUDE_PROJECT_DIR}/docs/plans/plan-checkout-v2.md`
...
```
# 현재 상태 빠르게 파악
/status ${CLAUDE_PROJECT_DIR}/docs/plans/plan-checkout-v2.md

# Story 착수
/story start E2-S2 ${CLAUDE_PROJECT_DIR}/docs/plans/plan-checkout-v2.md

# 기술 결정 회의
/meeting backend, compliance, data | <주제> | ${CLAUDE_PROJECT_DIR}/docs/meetings/<이름>.md

# PR 본문 자동 생성
/pr E2-S2 ${CLAUDE_PROJECT_DIR}/docs/plans/plan-checkout-v2.md

# 오늘 스탠드업
/standup ${CLAUDE_PROJECT_DIR}/docs/plans/plan-checkout-v2.md
```
...
- `${CLAUDE_PROJECT_DIR}/docs/onboarding/checkout-v2-backend.md` (조합)

보고:
```
✅ 온보딩 문서 생성 완료

산출물: ${CLAUDE_PROJECT_DIR}/docs/onboarding/backend-checkout-v2.md
대상: backend 역할 / checkout-v2 기능
